...
var RadarChart = {
  ...
  var cfg = {
	...
	//une ligne qui montre le 1
	var levelFactor = cfg.factor*radius/cfg.maxValue
	g.selectAll(".levels")
	 .data(allAxis)
	 .enter()
	 .append("svg:line")
	...
	for(var j=0; j<cfg.levels; j++){
	  ...
	  g.selectAll(".levels")
	   ...
	   .attr("transform", "translate(" + (cfg.w/2-levelFactor + cfg.ToRight) + ", " + (cfg.h/2-levelFactor+5) + ")")
	   .attr("fill", "#737373")
	   .text(Math.round(100*(j+1)*cfg.maxValue/cfg.levels) / 100);
	}
